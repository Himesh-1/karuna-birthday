  ...
  return (
    <section id="finale" className="relative w-full h-screen flex flex-col items-center justify-center text-center p-4 bg-transparent">
      ...
      <div className="max-w-3xl mx-auto">
        <h2 className="font-headline text-4xl md:text-7xl font-bold text-primary">
          Wishing You The Best!
        </h2>
        <p className="mt-6 font-body text-md md:text-xl text-muted-foreground leading-relaxed">
        ...
        <p className="mt-4 font-body text-md md:text-xl text-muted-foreground leading-relaxed">
